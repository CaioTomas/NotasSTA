...
\label{sec:integrais-e-transf-fourier}
    ...
    \subsection{Integrais Impróprias e o Valor Principal de Cauchy} %colocar o Lema Técnico aqui?
        ...
        %
        \begin{equation*}
            \lim_{\substack{b\to +\infty \\ a\to -\infty}} \int_a^b \sin{x} \, dx. 
        \end{equation*}
        %
        ...
        $\sin{x}$ não é Riemann integrável. No entanto, se $a = b = r$, i.e., se consideramos a mesma taxa, 
        ...
        \end{equation*}
        %
        pois $\cos r = \cos(-r)$. Portanto, $\sin{x}$ tem um valor principal de Cauchy.
        %
