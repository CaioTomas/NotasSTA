...
\label{sec:integrais-e-transf-fourier}
    ...
    \subsection{A medida de Lebesgue em \texorpdfstring{$\R$}{R}}
        ...
        \end{definicao}
        %
        Às vezes, nos referimos à propriedade 3) dizendo que $\mathcal{A}$ é fechada 
        ...
        função definida nele, restrita a qualquer $\sigma$-álgebra $\mathcal{B}$ 
        ...
        %
        \begin{exemplo}
        	Seja $\mathcal{A}$ uma $\sigma$-álgebra qualquer de subconjuntops de $\R$. 
        ...
        da seguinte função $\lambda:\mathcal{I}\to [0,+\infty]$
        ...
        devido a Carathéodory, que garante que coleção em questão é uma $\sigma$-álgebra
        ...
        que conhecido como Teorema de Lebesgue-Carathéodory 
        que garante que a restrição de $\lambda^*$ a $\sigma$-álgebra, 
        ...
        Mas porém, podemos dizer que praticamente só conhecemos um único
        ...
        Uma observação importante que ajuda, quando for necessário, provar
        ...
        cuja a técnica é valiosa por ser também utilizável em outras 
        ...
        definimos um conjunto $C_0 \equiv [0,1]$. Em seguida,
        definimos 
