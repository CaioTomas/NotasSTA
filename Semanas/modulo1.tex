...
% intro com teoria da medida (vide gravação Aula 8 & notas TPM GitHub Cioletti)

% seguir slides Aula 8:
%   - motivar a definição de integral imprópria usando a teoria da medida de Lebesgue
%   - falar do valor principal de Cauchy
%   - falar de "caminhos infinitos" (definidos na reta toda)
