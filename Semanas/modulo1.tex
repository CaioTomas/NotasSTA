...
\section{O logaritmo de uma função}
    ...
    Denote por $\y_j$ a função $\y$ restrita ao intervalo $[t_{j-1},t_j]$, ou seja, ela
...
% fazer a discussão introdutória (slides da Aula 1 e início dos slides da Aula 2)
    ...
    \begin{observacao}
        ...
        \begin{figure}[H]\centering
            ...
            \caption{%
                Destacado, exibe-se parte do conjunto 
                $\{z\in\C: \Re(z)>0\}$.
            }
        \end{figure}
        %
...
\section{Teorema de Monodromia}
    ...
    \begin{proof}
        ...
        \begin{figure}[H]\centering
            \includegraphics{%
                Figuras/interseção G.pdf
            }
            \caption{%
                Interseção $G$ destacado em azul marinho.
            }
        \end{figure}
        %
        Vamos mostrar que 
    ...
    \label{def-fep-homotopicas}
        ...
        \begin{figure}[H]\centering
            \includegraphics{%
                Figuras/curvas FEP-homotópicas.pdf
            }
            \caption{%
...
\label{sec:integrais-e-transf-fourier}
    ...
    Nesta seção, começamos a tratar da transformada de Fourier\index{Transformada!de Fourier}. Para tanto, é necessário
    primeiro definir de maneira mais rigorosa a integral complexa e a integral imprópria e,
    para este objetivo, tratamos brevemente da medida de Lebesgue. Para o leitor interessado neste assunto 
    recomendamos as referências
    \cite{MR1681462, MR1312157, MR1013117}.
    
    Embora dedicamos esta seção a uma breve introdução à 
    Medida de Lebesgue\index{Medida!de Lebesgue}, toda teoria de integração desenvolvida
    aqui é no sentido de Riemann. E a medida de Lebesgue
    é usada para fornecer uma caracterização, bem geral, 
    de quais funções reais são Riemann integráveis.
    
    \subsection{A medida de Lebesgue em \texorpdfstring{$\R$}{R}}
        Nesta seção vamos mostrar como é construída a medida de Lebesgue na reta real, conceito que será pouco usado neste texto. Para ser mais preciso, 
        ...
        Já que $\Leb(A)$ se propõe a ser uma generalização 
        ...
        uma função $\Leb:\P(\R)\to [0,+\infty]$, 
        onde $\P(\R)$ denota a coleção de todos os subconjuntos de $\R$,
        isto é, 
        \[
            \P(\R)
            \equiv 
            \{A\subset\R:\ A\ \text{é um subconjunto qualquer de}\ \R \}.
        \]
        Às vezes, $\P(\R)$ é chamado de conjunto das partes de $\R$\index{Conjunto!das partes de $\R$}.
        ...
        naturais (estas propriedades são relacionadas mais à frente,
        ...
        O segredo para encontrar a resposta desta 
        pergunta está no conceito de sigma-álgebra 
        (ou $\sigma$-álgebra) de conjuntos, que é apresentado logo abaixo. 
        %
        \begin{definicao}[$\sigma$-Álgebra]
        \label{def-sigma-algebra}
            Uma coleção $\A$ de subconjuntos de $\R$ é chamada de
            \index{Sigma-Álgebra! de conjuntos}{\it $\sigma$-álgebra} se satisfaz as seguintes condições:
            %
            \begin{itemize}
            	\item[1)] $\emptyset\in\A$ e $\R\in\A$;
            	
            	\item[2)] $A\in \A \implies A^c\in\A$;
            	
            	\item[3)] $A_n\in\A\ \, (n=1,2,\ldots) 
            				\implies 
            				\dis\bigcup_{n=1}^{\infty} A_n \in \A$.
            \end{itemize}
        \end{definicao}
        %
        Às vezes, nos referimos à propriedade 3) dizendo que $\A$ é fechada 
        para uniões enumeráveis. Note que tomando $A_n=\emptyset$, para todo 
        $n\geqslant n_0$, podemos verificar, usando 3), que $\A$ também é fechada 
        para uniões finitas. Observamos também que das propriedades 2) e 3) segue 
        que $\A$ é fechada para interseções finitas e enumeráveis.
    
        No que segue apresentamos dois exemplos de $\sigma$-álgebras de $\R$.
        %
        ...
        \begin{exemplo}
            ...
            A coleção $\B\equiv \P(\R)$ também é uma $\sigma$-álgebra
            de conjuntos de $\R$, e portanto um exemplo de
            $\sigma$-álgebra que possui uma quantidade infinita de elementos.
            
            As duas $\sigma$-álgebras deste exemplo são chamadas de $\sigma$-álgebras triviais de $\R$\index{Sigma-Álgebra! triviais de $\R$}.
        \end{exemplo}
        %
        ...
        desta coleção uma nova coleção $\A$, 
        contendo todos $I_j$'s, e que é uma $\sigma$-álgebra
        de subconjuntos de $\R$. 
    
        Para apresentar esta técnica vamos precisar introduzir alguns novos conceitos
        e resultados.
    
        Uma convenção importante quando falamos de medidas é que se 
        $\A$ denota uma $\sigma$-álgebra de conjuntos de 
        $\R$ e $I\subset \R$ é um subconjunto desta coleção, 
        então indicamos este fato escrevendo $I\in \A$. 
        ...
        %
        \begin{definicao}
            Um par ordenado da forma $(\R,\A)$, onde 
            $\A$ é uma $\sigma$-álgebra de conjuntos de $\R$ é chamado de 
            um espaço mensurável\index{Espaço! mensurável}. 
            Cada conjunto $I$ da coleção $\A$
            é chamado de um conjunto mensurável\index{Conjunto! mensurável} segundo $\A$. 
            Alternativamente, dizemos que $I$ é um conjunto 
            $\A$-mensurável\index{Conjunto! $\A$-mensurável} ou mesmo, quando não houver 
        ...
        subconjunto $I$ da reta pode ser mensurável 
        segundo uma $\sigma$-álgebra $\A$, mas não ser mensurável segundo 
        uma outra $\sigma$-álgebra $\B$. Por exemplo, 
        o intervalo fechado $[0,2]$ não é mensurável 
        segundo a $\sigma$-álgebra do Exemplo \ref{exemplo-sigma-algebra1}, 
        mas é um conjunto mensurável 
        segundo a $\sigma$-álgebra $\P(\R)$.
        Na verdade, o leitor mais atento deve ter percebido que
        qualquer subconjunto de $\R$ é mensurável segundo 
        a $\sigma$-álgebra $\P(\R)$. 
        
        \medskip 
        
        Sejam $\A$ e $\B$ $\sigma$-álgebras de conjuntos de $\R$.
        Dizemos que $\A$ é uma sub-$\sigma$-álgebra\index{Sub-sigma-Álgebra} de $\B$
        se $I\in\A$ implica $I\in\B$.
        
        Note que, segundo a definição acima, 
        qualquer $\sigma$-álgebra $\A$ de subconjuntos de $\R$ 
        sempre pode ser vista como uma sub-$\sigma$-álgebra de $\P(\R)$.
        %
        \begin{proposicao}
        \label{prop-intersecao-sigma-algebras}
            ...
            \[
                ...
                \equiv 
                \{
                    I\cap J \subset \R : I\in \A\ \textrm{e}\ J\in\B 
                \}
            \]
            %
            é também uma $\sigma$-álgebra de conjuntos de $\R$.
            Além do mais, $\A\cap \B$ é uma 
            sub-$\sigma$-álgebra de ambas $\A$ e $\B$.
        \end{proposicao}
        %
        ...
        indexada em $J$, isto é, $\{\A_{j}: j\in J\}$, definimos
        %
        \[
            \bigcap_{j\in J} \A_j
            \equiv
            \left\{ 
                ...
                I_j\in \A_j,\ \text{para cada}\ j\in J  
            \right\}.
        \]
        %
        \begin{lema}
        \label{lema-intersecao-arbitraria-sigma-algebras}
            ...
            $\A_j$, para cada $j\in J$, uma $\sigma$-álgebra 
            de conjuntos de $\R$. Então
            a coleção $\bigcap_{j\in J}\A_j$, 
        ...
        \label{def-sigma-algebra-gerada}
            ...
            Seja $\{\A_j: j\in J\}$ a coleção todas
            as $\sigma$-álgebras de conjuntos de $\R$ tal que 
            $\A_j$ contém toda a coleção $\mathcal{M}$, 
            para cada $j\in J$.
            Observe que esta coleção é não-vazia, uma vez que $\P(\R)$
            ...
            %
            \[
                \sigma(\mathcal{M})\equiv \bigcap_{j\in J} \A_j
            \]
            %
            é uma $\sigma$-álgebra. Esta $\sigma$-álgebra é chamada da 
            $\sigma$-álgebra gerada pela coleção $\mathcal{M}$\index{Sigma-Álgebra! gerada pela coleção $\mathcal{M}$}.
        \end{definicao}
        %
        \medskip 
        ...
        \medskip 
        %
        \begin{definicao}[Medida]\index{Medida}
        \label{def-medida}
            Seja $\A$ uma $\sigma$-álgebra de subconjuntos de $\R$.
            Uma função $\mu:\A\to [0,+\infty]$ é chamada de uma {\it medida} sobre $\R$ se
            %
            \begin{itemize}
        ...
        \end{definicao}
        %
        Nos referimos à propriedade do item 2) 
        da definição acima dizendo que a medida $\mu$ 
        é $\sigma$-aditiva ou contavelmente aditiva\index{Medida! $\sigma$-aditiva}. 
        Note que esta propriedade implica 
        na chamada aditividade finita de $\mu$, 
        isto é, se $A_1,\ldots, A_n$ são elementos
        da $\sigma$-álgebra $\A$, dois-a-dois disjuntos, então 
        $\mu(A_1\cup\cdots\cup A_n) = \mu(A_1)+\cdots+\mu(A_n)$
        (basta considerar uma sequência de conjuntos como no item 2) 
        ...
        %
        \begin{exemplo}
            Seja $\A \equiv \P(\R)$ a $\sigma$-álgebra 
            formada pelo conjunto das partes de $\R$. 
            A função $\mu:\A\to [0,+\infty]$ cuja a imagem de um subconjunto 
            $E\subset\R$ é dada por 
            \[
                \mu(E)=\sharp E \ \ (\textrm{a cardinalidade de}\ E)
            \]
            é uma medida sobre $\R$. Esta medida é chamada de medida da contagem em $\R$\index{Medida! da contagem em $\R$}.
        \end{exemplo}
        %
        \begin{exemplo}
        	Sejam $\A \equiv \P(\R)$ a $\sigma$-álgebra 
        	formada pelo conjunto das partes de $\R$, e $x\in\R$ 
        	um ponto arbitrário fixado. 
        	A função $\delta_x:\A\to [0,+\infty]$ 
        	definida para cada $E\in \A$ por
        	%
        	\[
            	\delta_{x}(E) = 
            	\begin{cases}
        	...
        	medida Delta de Dirac\index{Medida! Delta de Dirac}, concentrada em $x$.
        \end{exemplo}
        %
        Uma observação importante sobre o exemplo acima é que a 
        função nele definida, restrita a qualquer $\sigma$-álgebra $\B$ 
        ...
        Esta aparente ambiguidade acaba não gerando nenhuma 
        confusão já que, em geral, é claro sobre qual $\sigma$-álgebra estamos trabalhando. 
        %
        \begin{exemplo}
        	Seja $\A$ uma $\sigma$-álgebra qualquer de subconjuntos de $\R$. Sejam
        	$K_1$, $K_2$ constantes reais não-negativas, 
        	$\mu_1:\A \to [0,+\infty]$ e $\mu_2:\A \to [0,+\infty]$ medidas sobre $\R$. 
        	Então a função $\mu:\A\to [0,+\infty]$ definida para cada $E\in \A$ por
        	%
        	\[
        ...
        %
        \begin{lema}[Monotonicidade da Medida]
        \label{exercicio-monotonicidade-medida}
        	Sejam $\A$ uma $\sigma$-álgebra de conjuntos de $\R$ 
        	e $\mu:\A\to [0,+\infty]$ uma medida sobre $\R$.
        	Se $A$ e $B$ são quaisquer conjuntos $\A$-mensuráveis 
        ...
        na proposição abaixo.
        %
        \begin{proposicao}[Continuidade da Medida]
        \label{prop-cont-medida}
            Seja $\A$ uma $\sigma$-álgebra de subconjuntos de $\R$ e 
            $\mu:\A\to [0,+\infty]$ uma medida sobre $\R$. 
            \begin{itemize}
                \item[1)] Para qualquer sequência crescente $A_n$
                ($n=1,2,\ldots$) em $\A$, isto é,  
        ...
        o conjunto de índices, da definição de cobertura, como sendo $\Lambda = A$ e para cada 
        $\lambda\in A$ definir $I_{\lambda}\equiv (\lambda-1,\lambda+1)$. 
        ...
        $,
        onde $\Gamma\subset \Lambda$, é uma subcobertura\index{Subcobertura} de $\mathscr{C}$
        ...
        %
        \begin{teorema}[Teorema de Lindel\"of]
        \label{teo-lindelof}
        \index{Teorema! de Lindelöf}
        ...
        enorme de subconjuntos da reta, uma vez que $\lambda$ tem um expressão bem simples nos intervalos. 
        
        Em seguida, vamos usar $\lambda^{*}$ para definir uma coleção 
        de subconjuntos da reta. 
        Vamos enunciar outro resultado, 
        ...
        Esta é \textit{finalmente} a tão desejada medida de Lebesgue! 
        
        \bigskip
        
        Seguindo então nosso roteiro, vamos prosseguir introduzindo a função auxiliar
        $\lambda^*:\P(\R)\to\ [0,+\infty]$ que é definida
        para cada conjunto $A\in \P(\R)$ pela expressão
        %
        \begin{equation}
        ...
        Observamos que é necessário usar o Teorema de Lindel\"of (Teorema \ref{teo-lindelof})
        para garantir a existência de pelo menos uma cobertura enumerável de abertos limitados
        para $A$, e consequentemente que a função 
        $\lambda^*$ está bem definida para qualquer subconjunto $A\in\P(\R)$.
        %
        \begin{teorema}
            A função $\lambda^{*}:\P(\R)\to [0,+\infty]$, 
        ...
        \end{teorema}
        %
        \begin{teorema}[Lebesgue-Carathéodory]
        \label{teo-leb-carath}
        \index{Teorema! de Lebesgue-Carathéodory}
            A coleção 
            %
            \[
                \mathscr{L}
                ...
                \{ 
                    A\subset \R \ : \   
                    \lambda^{*}(A\cap T)+\lambda^{*}(A^c\cap T) = \lambda^{*}(T)
                    ,\  \forall T\in\P(\R) 
                \}
            \]
            %
            ...
            de Lebesgue-Carathéodory da reta\index{Sigma-Álgebra! Lebesgue-Carathéodory}.
        \end{teorema}
        %
        ...
        %
        \begin{teorema}[Medida de Lebesgue]
        \label{teo-def-medida-lebesgue}
            ...
            \begin{itemize}
                ...
                \item[2)] dados quaisquer $\alpha\in\R$,  $A\in\mathscr{L}$
                definido $\alpha\oplus A\equiv \{\alpha+a: a\in A\}$,
                temos
                \[\Leb(A)=\Leb(\alpha\oplus A);\]
                
                \item[3)] se $\mu:\mathscr{L}\to [0,+\infty]$ é 
                uma medida satisfazendo as conclusões dos itens 1) 
                e 2), então 
                $\mu=\Leb$. 
            \end{itemize}
        \end{teorema}
        ...
        por causa do item  1) do teorema acima, enquanto 
        a propriedade do item 2) é chamada de invariância translacional
        ...
        Por último, e não menos importante, o item 3) afirma que a medida de Lebesgue 
        ...
        como calcular facilmente o $\Leb$ de intervalos fechados, 
        semi-abertos e outros, usando a propriedade
        ...
        \begin{tabular}{%
            ...
            \]
        	&
        	\includegraphics{Figuras/An.pdf} 
        \end{tabular}
        
        Definindo a sequência $A_n$ ($n=1,2,\ldots$) de conjuntos, 
        para cada $n\in\N$, por 
        %
        \[
            A_n\equiv  \left(a-\frac{1}{n},b+\frac{1}{n}\right),
        \]
        %
        podemos verificar imediatamente que $A_n\subset A_{n+m}$, 
        ...
        podemos aplicar
        o item 2) da Proposição \ref{prop-cont-medida} 
        e o item 1) do Teorema \ref{teo-def-medida-lebesgue}  
        para concluir que
        %
        \begin{align*}
           \Leb([a,b]) 
        ...
        Esta pergunta é de difícil resposta, mas para acalmar o leitor 
        ...
        $\mathscr{L}\subset \P(\R)$ e esta continência é estrita. 
        ...
        de Vitali\index{Conjunto! de Vitali}. 
        ...
        é que todo conjunto aberto de $\R$ é Lebesgue-mensurável, consequência do Teorema de Lindel\"of. 
        
        De fato, 
        qualquer conjunto $A$ aberto de $\R$ pode
        ...
        união enumerável de intervalos abertos e limitados, isto é, 
        $A = \cup_{i=1}^{\infty} I_n$, onde $I_n\in\mathcal{I}$
        para cada $n\in\N$.
        Como cada intervalo aberto é um conjunto Lebesgue-mensurável 
        ...
        \begin{figure}[H]\centering
            \includegraphics{%
                Figuras/cobertura por abertos.pdf
            }
            \caption{%
                Exemplo de aberto $A$ e uma possível cobertura enumerável por abertos limitados.
            }
        \end{figure}
        %
        ...
        fechada por complementação (item 2) da Definição \ref{def-sigma-algebra})
        ...
        subconjunto enumerável de $\R$ é também um conjunto Lebesgue-mensurável. 
 
        Antes de rumar para a integração, 
        ...
        (o que pode ser feito usando o item 2) da 
        ...
        Antes de prosseguir, precisamos mostrar mais um resultado
        importante sobre a medida de Lebesgue conhecido
        como a $\sigma$-subaditividade\index{Sigma subaditividade} da medida de Lebesgue.
        ...
        \begin{proof}
            ...
            Iniciemos pela construção dos conjuntos $B_n$'s, que faremos por indução. Vamos explicar os três 
        ...
        %
        \begin{corolario}
            $\Leb(\Q) = 0$, onde $\Q$ denota o conjunto dos números racionais.
        \end{corolario}
        %
        ...
        Um exemplo clássico é dado pelo conjunto ternário de Cantor, $\mathbf{C}$\index{Conjunto!de Cantor}.
        
        Este conjunto também é definido indutivamente. Primeiro,
        ...
        remanescentes do passo anterior, ou seja, para cada $n\geqslant 1$ 
        %
        \begin{equation}
        \label{def-construcao-cn-cantor}
            ...
            \left( 
                ...
                \left( \frac{4}{3^n},\frac{5}{3^n} \right) \cup\cdots\cup
                \left( \frac{3^n-2}{3^n},\frac{3^n-1}{3^n} \right)
            \right).
        \end{equation}
        %
        Assim a cada etapa desta construção são removidos exatamente
        $3^n-2^n$ subintervalos de comprimento $3^{-n}$.
        ...
        \begin{tabular}{%
        	...
        	\centering
            $$
              \mathbf{C} \equiv \bigcap_{n=0}^{\infty} C_n.
            $$
        	&
        	\includegraphics{Figuras/conjunto de Cantor.pdf} 
        \end{tabular}
        \medskip
        ...
        é cômodo apresentar mais uma propriedade simples da medida de Lebesgue,
        ...
        \label{prop-Leb-diferenca}
            ...
            %
            \[
                \Leb\left(B\setminus \bigcup_{n=1}^{\infty} A_n \right) 
                = 
        ...
        %
        \begin{proof}
            Já que $A_n\subset B$ para todo $n\in\N$, segue que 
            $\cup_{n=1}^{\infty}A_n\subset B$. Portanto $B$ pode ser escrito como a seguinte união disjunta
            %
            \[
                B 
                = 
                \left( B\setminus \bigcup_{n=1}^{\infty} A_n\right)
                \cup
        ...
        \begin{proof}
            ...
            \[
                \Leb(\mathbf{C} )
                =
                \Leb\left(\bigcap_{n=0}^{\infty} C_n \right)
                =
                \lim_{n\to\infty} \Leb(C_n)
                =
                \lim_{n\to\infty} 1-\frac{3^{n}-2^n}{3^n}
                =
                1- 1 = 0.
            \]
            %
    ...
    \subsection{Integrais Impróprias e o Valor Principal de Cauchy} %colocar o Lema Técnico aqui?
        ...
        %
        \begin{definicao}[Riemann integrável]
        \label{def-riemann-integravel}
        \index{Função! Riemann integrável}
        ...
        %
        \begin{definicao}[Valor Principal de Cauchy]
        \label{def-valor-principal}
        \index{Valor Principal de Cauchy}
    ...
    \subsection{Integrais de Funções Complexas}
        ...
        \label{def-integral-complexa-tipo-1}
            ...
            $\dis \left[ a + \frac{b-a}{n}(j-1), a + \frac{b-a}{n}j \right] $.
        \end{definicao}
        %
        ...
        \label{def-valor-principal-integral-complexa-tipo-1}
            ...
            %
            \begin{align*}
                \lim_{a\to +\infty} \int\limits_{-a}^a f(t) \, dt
                &\equiv \text{VP}\left( 
                   \int\limits_{-\infty}^{\infty} f(t) \, dt 
                 \right) 
                \equiv \int\limits_{-\infty}^{\infty} f(t) \, dt 
                = \int\limits_{-\infty}^{\infty} f_1(t) \, dt + 
                 i\int\limits_{-\infty}^{\infty} f_2(t) \, dt
            \end{align*}
            %
        \end{definicao}
        %
        ...
        para aplicações da forma $\y:[a,b]\to\C$, 
        onde $[a,b]$ é um intervalo limitado e fechado da reta.
    ...
    \subsection{A classe \texorpdfstring{$\F$}{F}}
        ...
        \begin{exemplo}
            ...
            \begin{figure}[H]\centering
                \includegraphics{%
                    Figuras/invariação por conjugação.pdf
                }
                \caption{%
        ...
        %
        \begin{equation}
        \label{eq-trans-fourier-gaussiana}
        ...
        %
        \begin{figure}[H]\centering
            \includegraphics{Figuras/gama r.pdf}
        ...
        % \end{figure}
        %
        Os caminhos suaves $\y_1,\y_2,\y_3$ e $\y_4$ podem ser parametrizados da seguinte forma:
        %
        \begin{equation*}
            \begin{array}{ll}
        ...
        \begin{align*}
            ...
            \\[0.3cm]
            &\leqslant
            \int_{0}^{\xi} \exp(-\pi R^2)\exp(\pi t^2) \, dt
            \\[0.3cm]
            &=
            \xi\exp(\pi \xi^2) \exp(-\pi R^2).
        \end{align*}
        %
        ...
        %
    \subsection{Existência da transformada de Fourier em \texorpdfstring{$\F_a$}{Fa}}
        %
        ...
        \end{proof}
        %
    \subsection{Ação da transformada de Fourier em \texorpdfstring{$\F$}{F}}
        %
        \begin{teorema}
        \label{teo-transf-fourier-decai-exp}
            ...
            %
            \begin{equation*}
                |\widehat{f}(\xi)| \leq Be^{-2\pi b|\xi|}, 
                \qquad\forall 0\leq b < a.
            \end{equation*}
            %
        \end{teorema}
        %
        ...
        \index{Fórmula! da soma de Poisson}
            Se $f\in\F$, então
            %
            \begin{equation*}
                \sum_{n\in\Z} f(n) = \sum_{n\in\Z} \widehat{f}(n).
        ...
        \begin{proof}
            ...
            \begin{align*}
                ...
                \int_{-\infty}^{\infty}\!\!
                f(\xi - ib)(-1)
                e^{2\pi i n(\xi - ib)}\,d\xi \\[0.3cm]
                &= \sum_{n=0}^{\infty} \hat{f}(n+1) + \sum_{n=0}^{\infty} \hat{f}(-n) \\[0.3cm]
                &= \sum_{n \in \Z} \hat{f}(n).
            \end{align*}
            %
        \end{proof}
        ...
        \begin{align*}
            ...
            e^{2\pi i n(\xi + ib)} \, d\xi\right| \\[0.3cm]
            %
            &\leq \int_{\R \setminus [-N,N]}|f(\xi + ib)|\left|\sum_{n=0}^{N}
            e^{2\pi i n(\xi + ib)} \right|\, d\xi \\[0.3cm]
            %
            &\leq \int_{\R \setminus [-N,N]}\frac{A}{1 + \xi^2} 
            \sum_{n=0}^{N}|e^{2\pi i n(\xi + ib)}| \, d\xi \\[0.3cm]
            %
            &\leq \int_{\R \setminus [-N,N]}\frac{A}{1 + \xi^2}
    ...
    \subsection{O Teorema de Paley-Wiener}
        ...
        hipótese, chamaremos {\bf Hipótese da Fórmula de Inversão}, H.F.I.
        ...
        \begin{proof}
            ...
            \begin{align*}
               \int_{\y} f_n(z) \, dz 
               &= \int_{\y} \int_{-n}^n \widehat{f}(\xi) e^{2\pi iz\xi} \, d\xi \, dz 
               \\[0.3cm]
            ...
            \begin{align*}
                ...
                \int_{-n}^{n} \widehat{f}(\xi) e^{2\pi iz\xi} \, d\xi \right| \\[0.3cm]
                &= \left| \int_{\R\setminus [-n,n]} \widehat{f}(\xi) e^{2\pi iz\xi} \, d\xi \right| \\[0.3cm]
                &\leq \int_{\R\setminus [-n,n]} A e^{-2\pi (a-b)|\xi|} \, d\xi \\[0.3cm] 
                &< \e.
            \end{align*}
            %
        ...
        \end{definicao}
        %
        \begin{teorema}[Teorema de Paley-Wiener]
        \label{teo-paley-wiener}
        \index{Teorema!de Paley-Wiener}
            Seja $f:\R\to\R$ uma função contínua tal que $\displaystyle{ |f(x)| \leq \frac{A'}{1+x^2} }$
            para todo $x\in R$, com $A'>0$. A função $f$ admite uma extensão inteira satisfazendo
        ...
        \begin{proof}
            ...
            %
            \begin{align*}
                |F(z)| &= \left| \int_{-M}^M \widehat{f}(\xi) e^{2\pi iz\xi} \, d\xi \right| \\[0.3cm]
                       &\leq \int_{-M}^M |\widehat{f}(\xi)|\cdot|e^{2\pi iz\xi}| \, d\xi \\[0.3cm]
                       &\leq K \int_{-M}^M e^{\Re(2\pi iz\xi)} \, d\xi \\[0.3cm]
                       &= K \int_{-M}^M e^{-2\pi\Im(z)\xi} \, d\xi \\[0.3cm]
                       &\leq 2MK \sup_{\xi\in[-M,M]} e^{-2\pi\Im(z)\xi} \\[0.3cm]
                       &\leq 2MKe^{2\pi M|z|} \\[0.3cm]
                       &= Ae^{2\pi M|z|},
            \end{align*}
            %
            ...
            %
            \begin{align*}
                \left| \frac{1}{(1-i\e z)^2} \right| &= \frac{1}{|1-i\e z|^2} \\[0.3cm]
                                                     &= \frac{1}{|1+\e y - i\e x|^2} \\[0.3cm]
                                                     &= \frac{1}{(1+\e y)^2 + \e^2x^2} \\[0.3cm]
                                                     &\leq 1
            \end{align*}
            %
            ...
            \begin{align*}
                ...
                &\leq \int_{-\infty}^{\infty} |f(x)|\cdot\left| \frac{1}{(1-i\e x)^2} - 1 \right| \, dx \\[0.3cm]
                &\leq \int_{-\infty}^{\infty} \frac{A}{1+ x^2}\left| \frac{1}{(1-i\e x)^2} - 1 \right| \, dx \\[0.3cm]
                &= \int_{-\infty}^{-\delta} \frac{A}{1+ x^2}\left| \frac{1}{(1-i\e x)^2} - 1 \right| \, dx \\[0.3cm]
                &+ \int_{-\delta}^{\delta} \frac{A}{1+ x^2}\left| \frac{1}{(1-i\e x)^2} - 1 \right| \, dx \\[0.3cm]
            ...
            \begin{align*}
                \int_{\delta}^{\infty} \frac{A}{1+ x^2}\left| \frac{1}{(1-i\e x)^2} - 1 \right| \, dx
                &\leq \int_{\delta}^{\infty} \frac{A}{1+ x^2}\left| \frac{1}{(1-i\e\delta)^2} - 1 \right| \, dx \\[0.3cm]
            ...
            \begin{align*}
                ...
                &\leq \int_{-\infty}^{-\delta} \frac{A}{1+ x^2}\left| \frac{1}{(1-i\e\delta)^2} - 1 \right| \, dx \\[0.3cm]
            ...
            %
            \begin{align*}
                \left| \widehat{f_{\e}}(x+iy) \right| &\leq \frac{Ae^{2\pi M|y|}}{|1 - i\e (x+iy)^2|^2} \\[0.3cm]
                &= \frac{Ae^{2\pi M|y|}}{(1+ \e y)^2 + \e^2x^2} \\[0.3cm]
                &\stackrel{{\scriptsize(y\geq 0)}}{\leq} \frac{Ae^{2\pi M|y|}}{1 + \e^2x^2} \\[0.3cm]
                &= A\cdot\frac{1+x^2}{1 + \e^2x^2}\cdot\frac{e^{2\pi M|y|}}{1 + x^2} \\[0.3cm]
                &\leq \frac{A}{\e^2}\cdot\frac{e^{2\pi M|y|}}{1 + x^2} \\[0.3cm]
            ...
            \label{teo-phragmen-Lindelof}
            \index{Teorema!de Phragmén-Lindelöf}
