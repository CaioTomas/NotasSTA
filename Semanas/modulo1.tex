    ...
    \begin{proof}
        ...
        \begin{figure}[H]\centering
            \begin{tikzpicture}[scale=1.9]
        		% bolha externa 
        		\begin{scope}[scale=1.6, shift={(0.08, 0)}]
...
\label{sec:integrais-e-transf-fourier}
    ...
    \subsection{A classe \texorpdfstring{$\mathcal{F}$}{F}}
        ...
        \begin{equation*}
            ...
            f \text{ é holomorfa em } S_a\subseteq U \text{ e } f(\R)\subseteq\R \right\},
        \end{equation*}
        %
        ...
        \begin{figure}[H]
				...
				\node [at={(0,2)}, above right]{$a$};
				\node [at={(0,-2)}, below left]{$-a$};
        ...
        \begin{proof}
            ...
            \begin{figure}[H]
				...
				\node[at={(-4,-3)}, below]{$-R-ib$};
				\node [at= {(-4,0)}, above]{$-R$};
				\node [at={(2.7,0)}, above]{$\gamma_1$};
				\node [at={(4,-2.2)}, right]{$\gamma_2$};
				\node [at={(-2,-3)}, below]{$\gamma_3$};
				\node [at={(-4,-1.2)}, left]{$\gamma_4$};
				\draw[->] (2.5,0)--(2.9,0);
				\draw[->] (4,-2)--(4,-2.2);
				\draw[->] (-1.8,-3)--(-2,-3);
				\draw[->] (-4,-1.3)--(-4,-1.2);
            ...
            decaimento de $\widehat{h}$, i.e., mais rápido ela decairá.
        \end{proof}
        %