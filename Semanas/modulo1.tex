...
\label{sec:integrais-e-transf-fourier}
    ...
    \subsection{A medida de Lebesgue em \texorpdfstring{$\R$}{R}}
        Nesta seção vamos mostrar como é construída a medida de Lebesgue\index{Medida de Lebesgue} na reta real, conceito que será pouco usado neste texto. Para ser mais preciso, 
        ...
        é que todo conjunto aberto de $\R$ é Lebesgue-mensurável, consequência do Teorema de Lindel\"of. De fato, 
        ...
        fechada por complementação (item 2) Definição \ref{def-sigma-algebra})
