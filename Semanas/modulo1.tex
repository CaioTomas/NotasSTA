...
\label{sec:integrais-e-transf-fourier}
    ...
    \subsection{A classe \texorpdfstring{$\mathfrak{F}$}{F}}
        ...
        \begin{figure}[H]
            ...
            \caption{Esboço do traço do caminho $\gamma_{R}$, orientado positivamente.}
        ...
        sob certas condições, essa inversa realmente existe.
        %
    ...
    \subsection{Ação da transformada de Fourier em \texorpdfstring{$\mathfrak{F}$}{F}}
        ...
        \begin{proof}[Prova do Teorema \ref{teo-inv-transf-fourier}]
            ...
            \begin{figure}[H]
				...
				\node [at={(0,2)}, above right]{$ia$};
				\node [at={(0,-2)}, below right]{$-ia$};
				\draw[-latex,teal] (-5,1.2)--(5,1.2) node [at end,above]{$\gamma_2$};
				\node [at={(0,1.2)}, above left]{$ib$};
				\draw[-latex,teal] (-5,-1.2)--(5,-1.2) node [at end,above]{$\gamma_1$};
				\node [at={(0,-1.2)}, above left]{$-ib$};
				\end{tikzpicture}
			\end{figure}
        %
        ...
        \begin{proof}
            ...
            Lema Técnico (Lema \ref{}) e a hipótese de decaimento quadrático sobre $f$. 
            Denotaremos $R = N + 1/2$.
            %
            \begin{align*}
