...
\label{sec:integrais-e-transf-fourier}
    ...
    \subsection{Ação da transformada de Fourier em \texorpdfstring{$\mathfrak{F}$}{F}}
        ...
        \begin{proof}
            ...
            %
            \begin{align*}
                \sum_{n=0}^{\infty}\Big |\int_{-\infty}^{\infty} f(\xi + ib)
                e^{2 \pi i n(\xi + i b)} \, d\xi\Big | 
                &\leq \sum_{n=0}^{\infty}\int_{-\infty}^{\infty} |f(\xi + ib)|e^{-2 \pi nb} \, d\xi \\
        ...
        %
        \begin{equation*}
            |e^{2\pi n i(\xi + ib)}| = e^{-2\pi nb} \leq 1
        \end{equation*}
        %
        ...
        \end{equation*}
        %
        Temos que $\exp(2\pi i (\xi + ib)) = \exp(-2\pi b + i2\pi \xi)$ e, conforme $\xi$ varia, esse número percorre um círculo de raio $e^{-2\pi b} < 1$ com centro na origem. Portanto, $|1 - e^{2\pi i(\xi + ib)}| \geq 1 - e^{-2\pi b}$, como mostrado no diagrama abaixo.
        %
        \begin{center}
        ...
        Por definição, $I = \lim I_N$. Finalmente, vamos mostrar que $I = II$ 
        ...
        \end{equation*}
        %
        Como $|I - I_N| \to 0$ conforme $N \to \infty$, basta mostrar que, também, $|I_N - II| \to 0$.
