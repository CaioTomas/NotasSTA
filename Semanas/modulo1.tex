...
\label{sec:integrais-e-transf-fourier}
    ...
    \subsection{O teorema de Paley-Wiener}
        ...
        \begin{proof}
            ...
            \end{equation*}
            %
            Portanto, podemos estender $f$ em $\mathbb{H}$ por
            %
            \begin{equation*}
            ...
            \end{equation*}
            %
            podemos verificar que $f$ é contínua em $\overline{H}$...
            e, para todo $K\subseteq\overline{\mathbb{H}}$ compacto,
            temos
            %
            \begin{equation*}
                \sup_{z\in K} |f(z) - f_n(z)| \xrightarrow{n\to\infty} 0,
            \end{equation*}
            %
            de modo que $f$ é holomorfa em $\mathbb{H}$.
