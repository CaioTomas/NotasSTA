...
\label{sec:integrais-e-transf-fourier}
    ...
    \subsection{A classe \texorpdfstring{$\mathcal{F}$}{F}}
        %
        ...
        modo, a nossa classe de funções com transformada de Fourier, $\mathcal{F}$, pode ser
        ampliada.
        
        A construção de $\mathcal{F}$ será feita em duas etapas.
        
        \paragraph{1ª etapa.} Defina, para cada $a>0$,
        %
        \begin{equation*}
            \mathcal{F}_a = \left\{ f:U\subseteq\C\to\C \ | \ 
        ...
        %
        \begin{exemplo}
            Seja $f:\C\to\C$ dada por $f(z) = e^{-\pi z^2}$. Temos $f\in\mathcal{F}_a, \forall a>0$.
            ...
            \end{align*}
            %
            e, portanto, $f\in\mathcal{F}_a, \forall a>0$.
        \end{exemplo}
        %
        \begin{exemplo}
            ...
            \end{equation*}
            %
            pertence a $\mathcal{F}_a$ para todo $0 < a < c$\footnote{Essa $f$ pode parecer artificial,
        ...
        %
    \subsection{Existência da transformada de Fourier em \texorpdfstring{$\mathcal{F}_a$}{Fa}}
        %
        Nesta subseção, vamos mostrar que a transformada de Fourier está bem definida em cada $\mathcal{F}_a$.
        ...
        \begin{proof}
            ...
            Lembrando que $f\in\mathcal{F}_a$, dado $\e>0$ podemos encontrar $n_0\in\N$ 
        ...
        \begin{proof}
            ...
            que a transformada de Fourier está bem definida em cada $\mathcal{F}_a$.
        \end{proof}
        %
    \subsection{Ação da transformada de Fourier em \texorpdfstring{$\mathcal{F}$}{F}}
        %
        \begin{teorema}
        \label{teo-transf-fourier-decai-exp}
            Se $f\in\mathcal{F}_a$ para algum $a>0$, então
            %
            \begin{equation*}
        ...
        \label{transf-fourier-inv-por-shift}
            ...
            para todo $0\leq b < a$, sendo $a > 0$ tal que $f\in\mathcal{F}_a$:
            %
            \begin{align*}
                \int_{-\infty}^{\infty} f(x-ib)e^{-2\pi i(x-ib)\xi} \, dx
                =
        ...
        $\mathcal{F}$.
        %
        \begin{definicao}[Classe $\mathcal{F}$]
        \label{def-classe-F}
            A classe $\mathcal{F}$ é o espaço de todas as funções que pertencem a $\mathcal{F}_a$
        ...
        \label{teo-inv-transf-fourier}
            Se $f\in\mathcal{F}$, vale a igualdade
            %
            \begin{equation*}
        ...
        \begin{proof}[Prova do Teorema \ref{teo-inv-transf-fourier}]
            ...
            Digamos que $f\in\mathcal{F}_a$ para algum $a>0$. Escolha $b\in\R$ tal que $0 < b < a$.
        ...
        %
        \begin{proof}
            Como $f\in\mathcal{F}$, existe $a > 0$ tal que $f\in\mathcal{F}_a$. Seja 
        ...
        %
        \begin{lema}
            Seja $f \in \mathcal{F}_a$. Para qualquer $b$ real satisfazendo $0 < b < a$, 
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                ...
                \node[above] at (0,5) {$\Im$};
                \draw (0,0) circle (1.5);
                \node[below right] at (1.5,0) {$e^{-2\pi b}$};
                \node at (1.5,0) {$\bullet$};
                \node[above right] at (4,0) {$1$};
                \node[above right] at (1,1.118034) {$e^{2\pi i(\xi + ib)}$};
                \node at (1,1.118034) {$\bullet$};
                \draw[thick, red] (4,0)--(1.5,0);
                \draw[blue] (4,0)--(1,1.118034);
                \node[above left] at (-1,1.118034) {$e^{2\pi i(\xi + ib)}$};
                \node at (-1,1.118034) {$\bullet$};
                \draw[blue] (4,0)--(-1,1.118034);
            \end{tikzpicture}
        \end{figure}
    ...
    \subsection{O teorema de Paley-Wiener}
        ...
        \begin{proof}
            ...
            que aproxima $F$, usamos Fubinir e Morera para verificar
            ...
            \begin{figure}[H]
                ...
                \begin{tikzpicture}
                    ...
                    \node[left] at (0,1) {$\delta$};
                    \node at (0,1) {$\circ$};
                    \node[left] at (0,-1) {$-\delta$};
                    \node at (0,-1) {$\circ$};
                    \node[left] at (0,-2.5) {$-i\e x$};
                    \node at (0,-2.5) {$\bullet$};
                    \node[left] at (0,2.5) {$i\e x$};
                    \node at (0,2.5) {$\bullet$};
                    \node[above right] at (4,0) {$1$};
                    \node at (4,0) {$\bullet$};
                    \draw[thick, red] (4,0) -- (0,1);
                    \draw[thick, red] (4,0) -- (0,-1);
                    \draw[blue] (4,0) -- (0,2.5);
                    \draw[blue] (4,0) -- (0,-2.5);
                    \node[right] at (5,0) {$\Re$};
                    \node[above] at (0,3.5) {$\Im$};
                \end{tikzpicture}
            \end{figure}
            %
