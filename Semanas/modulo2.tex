...
\section{Produtos Infinitos}
    ...
    \begin{proof}
       ...
       \begin{align*}
           ...
           &\leq \sup_{w\in D\left( 0, 2\sum_{n\in\N} c_n \right)} 
       ...
       \begin{equation*}
           G_n'(z) - F_n'(z) = 
           \frac{1}{2\pi i} \int_{\y} (G_n(w) - F_n(w))\frac{1}{(w-z)^2} \, dw
       \end{equation*}
       %
       ...
       \end{figure}
       %
       Por hipótese, $F_n(z) \neq 0$ para todo $n\in\N$ e $z\in\Omega$, de modo
       ...
       \end{equation*}
       %
       Portanto, podemos garantir que $G_n(z)$ é uniformemente limitada por
       baixo em $n$ e $z\in K$. De fato,
       %
       \begin{align*}
       ...
       \begin{equation*}
           ...
           \geq \min\left\{ I_K, \frac{1}{2}|F(z_*)| \right\},
       \end{equation*}
       %
       donde segue que 
       %
    ...
    \begin{exemplo}[A fórmula do produto da função seno]
        ...
        Vamos mostrar que, para todo $z\in\C\setminus\mathbb{Z}$, temos
        %
        \begin{equation*}
        ...
        $\res(H,0)$, de modo que $z=0$ é uma singularidade removível de $H$.
        ...
        $H$ é limitada e usar o teorema de Liouville, uma vez que $H(0) = 0$.
        
        Para mostrar que $H$ é limitada, basta trabalhar na faixa
        %
        \begin{equation*}
        ...
        %
        \begin{equation}
            \sup_{z\in S_1} |H(z)| = k_1 < +\infty.
        \end{equation}
        %
        pois $S_1 \cap S_{\frac{1}{2}}$ é um compacto, como ilustrado abaixo.
        %
        \begin{center}
            {\bf diagrama slide 28 Aula 15}
        \end{center}
        %
        ...
        %
        \begin{equation*}
            S_{1^+} = \left\{ z\in\C : |\Im(z)| > 1 \right\}.
        \end{equation*}
        %
        Ora, se $z = x+iy$ e $y>1$, então
        %
        \begin{align*}
            \cot(\pi z) &= 
        ...
        \begin{align*}
            ...
            &\leq 1 
            + \sum_{n=1}^{\infty} \frac{1}{y^2 + n^2 - x^2}
            + \sum_{n=1}^{\infty} \frac{|2y|}{y^2 + n^2 - x^2} \\
            &= 1 + C + 2\sum_{n=1}^{\infty} \frac{y}{y^2 + n^2 - x^2} \\
            &\leq 1 + C + 2\sum_{n=1}^{\infty} \frac{y}{y^2 + n^2 - 1} \\
            &\leq C' + 2\int_0^{\infty} \frac{y}{y^2 + u^2 - 1} \, du,
        \end{align*}
        %
        uma vez que a função $\dis{ \frac{y}{y^2 + u^2 - 1} }$ é decrescente em $u$.
        Ademais, temos que
        %
        \begin{align*}
            \int_0^{\infty} \frac{y}{y^2 + u^2 - 1} \, du
            = \frac{\pi y}{2\sqrt{y^2 - 1}} % aqui eu usei o Wolfram
            \leq \pi, % aqui eu usei o GeoGebra
        \end{align*}
        %
        ...
        \begin{equation*}
            |H(z)| \leq |F(z)| + |S(z)| 
                   \leq \pi\widetilde{k_1} + \widetilde{k_2}
                   < +\infty,
        \end{equation*}
        %
        ou seja, $H$ é limitada para $y>1$. Um argumento similar nos mostra
        que $H$ também é limitada para $y < -1$, de modo que $H$ é limitada
        em toda a faixa $S_{\frac{1}{2}}$. Logo, da periodicidade de $H$,
        segue que essa função é limitada em $\C$ e, pelo teorema de Liouville,
        $H(z)$ é constante. Como $H(0) = 0$, segue que $H\equiv 0$, ou seja,
        $F(z) \equiv S(z)$.
        ...
        \end{align*}
        %
        Pela Proposição \ref{prop:prod-inf-func-holom} e do fato de que a série
        de $1/n^2$ converge absolutamente temos que $P(z)$ converge e, longe
        dos inteiros, temos
        %
        \begin{equation*}
        ...
        \end{equation*}
        %
        Como $G'(z)/G(z) = \pi\cot(\pi z)$, o resultado que acabamos de mostrar
        nos dá
        %
        \begin{equation*}
        ...
        \end{equation*}
        %
        de modo que $P(z) = cG(z)$ para alguma constante $c$. Ora, então
        %
        \begin{equation*}
            1 
        ...
        \end{equation*}
        %
        ou seja, $P(z) = G(z)$ e fica demonstrada a fórmula.
    \end{exemplo}