...
o que encerra a prova do teorema.
    ...
    \label{prop-psi-tchebychev-von-mangoldt}
        ...
        \Lambda(n) = \begin{cases}
            \ln p, \, \text{ se } n = p^m \text{ para algum primo } p \text{ e } m\geq 1 \\
            0, \, \text{ caso contrário}
        \end{cases},
        \]
        %
        chamada função de Von Mangoldt\index{Função!de Von Mangoldt}.
    \end{proposicao}
    %
    \begin{proof}
        a
    ...
    \label{prop-psi-piso}
        ...
        \]
        %
        sendo $\lfloor\cdot\rfloor$ a função piso.
    \end{proposicao}
    %
    \begin{proof}
    ...
    \end{equation}
    %
    {\red Falar mais dessa definição...}
    ...
    \begin{proof}
        ...
        \iff \frac{1}{(1 - \alpha)x}\int_{\alpha x}^x \psi(u) \, du \leq \psi(x),
        \]
        %
        como ilustrado abaixo.
        %
        \begin{center}
            {\bf DIAGRAMA ILUSTRANDO A COTA DA INTEGRAL}
        \end{center}
        %
        ...
        \iff \psi(x) \leq \frac{1}{(\beta - 1)x}\int_x^{\beta x} \psi(u) \, du,
        \]
        %
        como ilustrado abaixo.
        %
