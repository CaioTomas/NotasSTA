...
\section{Produtos Infinitos}
    ...
    \begin{exemplo}[A fórmula do produto da função seno]
        ...
        \begin{figure}[H]\centering
            ...
            \caption{%
                A região hachurada, $S_\frac{1}{2} \cap S_1$, é um compacto.
            }
        \end{figure}
        %
        ...
        \begin{equation*}
            ...
            \leq
            \int_1^{\infty} \frac{|y|}{|y|^2 + x^2} \, dx.
        \end{equation*}
        %
        \begin{center}
            {\bf diagrama slide 19 Aula 16}
        \end{center}
        %
        ...
        \begin{align*}
            \int_1^{\infty} \frac{|y|}{|y|^2 + x^2} \, dx = 
            \int_{1/|y|}^{\infty} \frac{1}{1 + u^2} \, du =
            \frac{\pi}{2} - \arctan\left( \frac{1}{|y|} \right) \leq
            \frac{\pi}{2}.
        \end{align*}
        %
        ...
        \begin{enumerate}
            ...
            \leq 1 + \frac{\pi^2}{6} + 8\int_1^{\infty} \frac{|y|}{|y|^2 + x^2} \, dx
            \leq 1 + \frac{\pi^2}{6} + 4\pi =
            \widetilde{k_2}}$,
        \end{enumerate}
        %
        donde segue que
