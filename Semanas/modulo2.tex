...
o que encerra a prova do teorema.
    ...
    \begin{proof}
        ...
        \begin{enumerate}
            ...
            %
            \begin{align*}
                \zeta'(s) &= \frac{1}{2\pi i}\int_{\y} \frac{\zeta(w)}{(w-s)^2} \, dw \\
                          &= \frac{1}{2\pi i}\int_0^{2\pi} \frac{\zeta(\y(\theta))}{(\y(\theta) - s)^2} \y'(\theta) \, d\theta \\
                          &= \frac{1}{2\pi i}\int_0^{2\pi} \frac{\zeta(s + re^{i\theta})ire^{i\theta}}{(re^{i\theta})^2} \, d\theta \\
                          &= \frac{1}{r}\zeta(s + re^{i\theta}) e^{-i\theta}.
            \end{align*}
            %
            Daí, segue que
            %
