 ...
 \bigskip 
    ...
    \begin{proof}
        ...
        \begin{equation*}
            ...
            \leq \frac{2^{k+1-s}}{|a_n|^s|z|^{k+1-s}}.
        \end{equation*}
        %
        Daí,
        %
        ...
        \begin{align*}
            ...
            \geq 
            \exp\left(
            -2|z|^{k+1} \cdot \frac{2^{k+1}}{|z|^{k+1-s}}
            \sum_{\substack{n\in\N \\ |a_n| > 2z}} \frac{1}{|a_n|^s}
            \right)
            \equiv \exp\left(
            -C_1(k,s) |z|^s
        ...
        \end{equation*}
        %
        vamos usar o item ii) do Lema \ref{lema:5.2-Stein}.
        % reler o Stein e deixar mais explícitas as contas, 
    \end{proof}
    %