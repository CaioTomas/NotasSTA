...
o que encerra a prova do teorema.
    ...
    \begin{proof}
        ...
        \]
        %
        Para majorar a segunda parcela que aparece na expressão \eqref{eq-expressao-inv-gama}, precisamos majorar
        ...
        Primeiro, vamos considerar o caso $0 < |s| < 1$. Neste caso podemos afirmar que
        %
        \begin{align*}
            \exp\Big((|\sigma|+1)\ln(|\sigma|+1)\Big) 
                                            &\leq \exp\Big((|s|+1)\ln(|s|+1)\Big) \\[0.3cm]
                                            &= \exp\Big(|s|\ln(|s|+1)\Big) \exp\Big(\ln(|s|+1)\Big) \\[0.3cm]
                                            &\leq 2\exp\left( |s|\ln\left( |s|\Big(1 + \frac{1}{|s|}\Big) \right) \right) \\[0.3cm]
