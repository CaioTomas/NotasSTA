...
\section{Produtos Infinitos}
    ...
    \label{prop:prod-inf-func-holom}
        Seja $\{ F_n \}_{n\in\N}$ é uma sequência de funções holomorfas
...
\section{O Teorema de Weierstrass}
 ...
 \bigskip 
    ...
    \label{teo:fatoracao-hadamard}
        ...
        Seja $\Z\ni k = \lfloor \rho_0 \rfloor$. Se $a_1, a_2, \dots \in\C^*$ são os 
    ...
    \begin{proof}
        \begin{enumerate}[i)]
            \item Para $z\in\C$ tal que $|z| \leq 1/2$, temos que 
            ...
            \]
            %
            e está verificada a validade de i).
            
            \item Por definição, para todo $k\geq 1$ temos que
            %
            \begin{align*}
                |E_k(z)| &= |1-z| \cdot \left| 
            ...
            \]
            %
            encerrando a prova do item ii) e do lema.
        \end{enumerate}
    \end{proof}
    %
