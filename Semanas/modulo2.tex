...
o que encerra a prova do teorema.
    ...
    \begin{proof}
        ...
        \begin{align*}
            ...
            &= \int_1^x \left( \sum_{n=1}^{\lceil x \rceil} \Lambda(n) f_n(u) \right) \, du \\
            &= \sum_{n=1}^{\lceil x \rceil} \Lambda(n) \int_1^x f_n(u) \, du \\
            &= \sum_{n=1}^{\lceil x \rceil} \Lambda(n) \int_n^x du \\
