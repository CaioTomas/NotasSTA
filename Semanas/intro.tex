...
Colocar a tradução do Cap1 do Edwards
    ...
    \end{equation}
    %
    devida a Euler. Aqui $n$ percorre todos os inteiros positivos $(n=1,2,3, \dots)$ e $p$, todos os primos $(p=2,3,5,7,11,\dots$. Esta fórmula, conhecida como "fórmula do produto de Euler", resulta de expandir todos os fatores à direita
    %
