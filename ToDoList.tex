...
\begin{todolist}
    ...
    \item demonstrar a proposição e o corolário na subseção de existência da transformada de Fourier;
    \item demonstrar o lema da integral da exponencial (auxiliar para a inversão da transformada);
